#!/usr/bin/env bash
# Refresh all four backup feeds byte-exact from live Remote Config
...
# (hksamsung removed 2026-08-11: flavor deprecated 2026-08-02; rc.py now
# rejects it as an unknown market, which made every run exit nonzero.)
set -euo pipefail
